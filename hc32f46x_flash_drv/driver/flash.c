...
#define EFM_WaitForOperationDone(u32Timeout, pRet)  \
do {                                              \
    volatile uint32_t u32Delay = 0;               \
    /* Wait for the EFM operation to complete by polling on RDY flag */ \
...
// #pragma arm section code = "FLASH_DRIVER_SECTION"
...
en_efm_status_t EFM_EraseSector(uint32_t u32Addr)
{
    ...
    EFM_WaitForOperationDone(1000, &enStatus);
